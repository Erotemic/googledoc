...
Notes:
    ...
    cd ~/code/googledoc/docs
    sphinx-apidoc -f -o ~/code/googledoc/docs/source ~/code/googledoc/googledoc --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/googledoc/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/googledoc/versions/
"""
#
...
# html_logo = '.static/googledoc.svg'
# html_favicon = '.static/googledoc.ico'
...
htmlhelp_basename = 'googledocdoc'
...
latex_documents = [
    (master_doc, 'googledoc.tex', 'googledoc Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'googledoc', 'googledoc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'googledoc', 'googledoc Documentation',
     author, 'googledoc', 'One line description of project.',
     'Miscellaneous'),
]
